            ...
            <div className="container mx-auto px-4 max-w-3xl">
                ...
                <Accordion type="single" collapsible className="w-full space-y-4">
                    <AccordionItem value="item-1" className="border border-white/10 rounded-lg px-4 bg-white/5">
                        <AccordionTrigger className="text-lg hover:no-underline">How long does a website project take?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2" className="border border-white/10 rounded-lg px-4 bg-white/5">
                        <AccordionTrigger className="text-lg hover:no-underline">Do you provide hosting and domain?</AccordionTrigger>
                        <AccordionContent className="text-white/60">
                    ...
                    <AccordionItem value="item-3" className="border border-white/10 rounded-lg px-4 bg-white/5">
                        <AccordionTrigger className="text-lg hover:no-underline">Is the design mobile-friendly?</AccordionTrigger>
                        <AccordionContent className="text-white/60">
                    ...
                    <AccordionItem value="item-4" className="border border-white/10 rounded-lg px-4 bg-white/5">
                        <AccordionTrigger className="text-lg hover:no-underline">What is your payment structure?</AccordionTrigger>
                        <AccordionContent className="text-white/60">
